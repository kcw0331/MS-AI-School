import os
import glob
import argparse # 사용자에게 입력받기 위한 인자
...
# 폴더 구성 /dataset/image/각폴더명 생성/ 이미지 저장해주면 된다. (resize 400 x 400)
...
def image_prossing(orange_data, grapefruit_data, kanpei_data, dekopon_data): 
    orange = orange_data
    ...
    for i in dekopon:
        ...
        dekopon_img_resize.save(
            f"./dataset/image/dekopon/dekopon_{file_name}")
...
if __name__ == "__main__":
    ...
    image_prossing(orange_data, grapefruit_data, kanpei_data, dekopon_data)
