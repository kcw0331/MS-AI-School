...
class MultiLayerNet:
    ...
    hidden_siz_list = 각 은닉층의 뉴런 수를 담은 리스트 -> [100, 100, 100]
    output_size -> 출력 크기 (MNIST -> 10) MNIST기준으로 10개이다.
    ...
    def __init__(self, input_size, hidden_size_list, output_size, activation='relu', 
        ...
        self.hidden_size = hidden_size_list
        ...
        for idx in range(1, self.hidden_layer_number+1):
            self.layers['Affine' +
                        str(idx)] = Affine(self.params['W' + str(idx)],
    ...
    def __init_weight(self, weight_init_std):
        ...
        for idx in range(1, len(all_size_list)):
            ...
            elif str(weight_init_std).lower() in ('signoid', 'xavier'):
    ...
    def gradient(self, x, t):
        ...
        # 결과 저장
        grads = {}
        for idx in range(1, self.hidden_layer_nnumber + 2):
            grads['W' + str(idx)] = self.layer['Affine' + str(idx)].dw + \
